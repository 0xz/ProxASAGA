...
import os, tarfile, scipy, cffi, time
import numpy as np
from scipy import sparse
from sklearn.datasets import load_svmlight_file

from tick.dataset.download_helper import  get_data_home
...
if __name__ == '__main__':
    ...
    max_trace_time = 0
    max_epochs = 200
    for i, n_jobs in enumerate([2, 4, 6, 8, 10, 12, 14, 16]):

        #print("running SAGA for n_threads " , n_jobs)
        ...
        for j, t in enumerate(trace_time):
          print(n_jobs, ",", j * n_jobs, "," , t, "," , func_trace[j])
